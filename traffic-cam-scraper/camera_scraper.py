...
url_front = "https://cocam.carsprogram.org/Live_View/US550076North.jpg?" #https://www.cotrip.org/list/cameras#media/camera/560/2234927265#portion of url before camera id
url_end = "" # portion url after the camera ID
camera_ids = ['1668180960000'] # Camera id (part of url that changes to indicate camera)
